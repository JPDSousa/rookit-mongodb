...
class MorphiaArtistUpdateFilterQuery extends AbstractGenreableUpdateFilterQuery<Artist, ArtistQuery, ArtistUpdateFilterQuery>
		implements ArtistUpdateFilterQuery {

	protected MorphiaArtistUpdateFilterQuery(ArtistQuery filter, UpdateOperations<Artist> updateQuery) {
